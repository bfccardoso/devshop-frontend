...
const Product = ({ product, categories }) => {
  ...
  const isVariation1Disabled = value => {
    return !(variation2 === '' || validVariations1.includes(value))
  }
  const isVariation2Disabled = value => {
    return !(variation1 === '' || validVariations2.includes(value))
  }
                  ...
                  <div className='relative'>
                    ...
                    >
                      ...
                      {possibleValues1.map(pv => (
                        <option key={pv} disabled={isVariation1Disabled(pv)}>
                          {pv} {isVariation1Disabled(pv) && '(indisponível)'}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className='relative'>
                    ...
                    >
                      ...
                      {possibleValues2.map(pv => (
                        <option key={pv} disabled={isVariation2Disabled(pv)}>
                          {pv} {isVariation2Disabled(pv) && '(indisponível)'}
                        </option>
                      ))}
                    </select>
                    <span className='absolute right-0 top-0 h-full w-10 text-center text-gray-600 pointer-events-none flex items-center justify-center'>
